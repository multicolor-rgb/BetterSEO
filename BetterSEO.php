<?php
	...
	add_action('plugins-sidebar','createSideMenu',array($thisfile,'BetterSEO Settings'));
	...
	function betterSEO(){
		...
		<div class="tab-content-2">
			...
			<ul class="leader">	
				<li>GeoLocation Meta Tags / Geotagging. Used for custom results in Google. Generator here: https://www.geo-tag.de/generator/en.html</li>
				<li>Open Graph protocol, more here: https://ogp.me/</li>
				<li>Dublin Core Metadata, more here: http://purl.org/dc/elements/1.1/</li>
				<li>Favicons. Generator here: https://www.favicon-generator.org/</li>
			</ul>
		...
		<div style="padding:20px;text-align:center;box-sizing:border-box;" id="paypal">
